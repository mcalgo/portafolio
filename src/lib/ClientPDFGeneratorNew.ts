...
export class ClientPDFGenerator {
  ...
  private setupDocument(options: CVOptions): void {
    ...
    this.doc.setProperties({
      ...
      subject: 'Curriculum Vitae - Backend Developer',
  ...
  private addModernHeader(personalInfo: any, options: CVOptions, colors: any): void {
  ...
  private addPersonalInfo(personalInfo: any, options: CVOptions, colors: any): void {
  ...
  private addSkillsCompact(skills: any[], options: CVOptions, colors: any): void {
    ...
    Object.entries(skillsByCategory).forEach(([category, categorySkills]) => {
      ...
      (categorySkills as any[]).slice(0, 4).forEach(skill => {
  ...
  private addExperienceModern(experience: any[], options: CVOptions, colors: any): void {
  ...
  private addProjectsModern(projects: any[], options: CVOptions, colors: any): void {
  ...
  private addModernFooter(options: CVOptions, colors: any): void {
  ...
  private addSectionTitleLeft(title: string, colors: any): void {
    this.doc.setFontSize(11);
    this.doc.setFont('helvetica', 'bold');
    this.doc.setTextColor(colors.primary);
  ...
  private addSectionTitleRight(title: string, colors: any): void {
    this.doc.setFontSize(11);
    this.doc.setFont('helvetica', 'bold');
    this.doc.setTextColor(colors.primary);
  ...
  private getThemeColors(options: CVOptions) {
