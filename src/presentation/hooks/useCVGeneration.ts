...
function getMockSkills() {
  return [
    // Backend & APIs
    { name: 'C#', level: 95, category: 'backend', experience: 7, isExpert: true, icon: '🔷' },
    { name: '.NET Core', level: 90, category: 'backend', experience: 6, isExpert: true, icon: '⚡' },
    { name: 'ASP.NET', level: 95, category: 'backend', experience: 7, isExpert: true, icon: '🌐' },
    { name: 'Python', level: 90, category: 'backend', experience: 3, isExpert: true, icon: '�' },
    { name: 'FastAPI', level: 75, category: 'backend', experience: 2, isExpert: false, icon: '⚡' },
    { name: 'Flask', level: 80, category: 'backend', experience: 3, isExpert: false, icon: '�' },
    { name: 'Orionis Framework', level: 95, category: 'backend', experience: 1, isExpert: true, icon: '🏗️' },
    { name: 'Background Workers', level: 90, category: 'backend', experience: 6, isExpert: true, icon: '⚡' },
    { name: 'Python Daemons', level: 85, category: 'backend', experience: 2, isExpert: true, icon: '�' },
    
    // Frontend & Mobile
    { name: 'TypeScript', level: 70, category: 'frontend', experience: 4, isExpert: false, icon: '💙' },
    { name: 'JavaScript', level: 70, category: 'frontend', experience: 4, isExpert: false, icon: '💛' },
    { name: 'Angular', level: 65, category: 'frontend', experience: 4, isExpert: false, icon: '🅰️' },
    { name: 'Xamarin', level: 80, category: 'frontend', experience: 3, isExpert: true, icon: '�' },
    { name: '.NET MAUI', level: 60, category: 'frontend', experience: 1, isExpert: false, icon: '📲' },
    { name: 'Flutter', level: 55, category: 'frontend', experience: 1, isExpert: false, icon: '📱' },
    
    // Bases de Datos
    { name: 'SQL', level: 95, category: 'database', experience: 7, isExpert: true, icon: '💾' },
    { name: 'PL/SQL', level: 95, category: 'database', experience: 7, isExpert: true, icon: '📝' },
    { name: 'Oracle DB', level: 85, category: 'database', experience: 4, isExpert: true, icon: '�' },
    { name: 'Oracle APEX', level: 80, category: 'database', experience: 3, isExpert: true, icon: '🏛️' },
    { name: 'Data Lakes', level: 65, category: 'database', experience: 1, isExpert: false, icon: '🏞️' },
    
    // Herramientas & DevOps
    { name: 'RAP', level: 70, category: 'tools', experience: 1, isExpert: false, icon: '🔧' },
    { name: 'OCR', level: 65, category: 'tools', experience: 1, isExpert: false, icon: '👁️' },
